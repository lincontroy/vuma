...
@section('content')
    ...
    @php
        ...
        $profileComplete =
            $userDetails && $userDetails->employment_details_completed && $userDetails->financial_details_completed;
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-warning alert-dismissible">
                    ...
                    <p>You need to complete your profile before applying for loans. Your profile is
                        {{ $completionPercentage }}% complete.</p>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        @else
                            <button type="button" class="btn btn-secondary btn-sm" disabled data-toggle="tooltip"
                                data-placement="left" title="Complete your profile to apply for loans">
